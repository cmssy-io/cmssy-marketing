...
function highlightSyntax(code: string, language: string): string {
  ...
  const keywords = {
    javascript:
      /\b(const|let|var|function|return|if|else|for|while|import|export|from|default|async|await|class|extends|new|this|try|catch|throw)\b/g,
    typescript:
      /\b(const|let|var|function|return|if|else|for|while|import|export|from|default|async|await|class|extends|new|this|try|catch|throw|interface|type|enum|implements|readonly|private|public|protected)\b/g,
    ...
    python:
      /\b(def|class|import|from|return|if|elif|else|for|while|try|except|with|as|in|not|and|or|True|False|None)\b/g,
  };
